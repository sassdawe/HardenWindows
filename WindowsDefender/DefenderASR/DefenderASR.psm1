...
try {
    ...
    Get-Content "$scriptPath\Config\ASR-Rules.json" | ConvertFrom-Json | ForEach-Object { $_ } | ForEach-Object { $rules.Add($_.GUID, $_) }
    ...
    $states.Add("6", [PSCustomObject]@{"Id" = 6; "Name" = "Warn" })
